...
- **本项目代码**：Apache License 2.0（见根目录 `LICENSE`）
- **VB-CABLE 驱动文件**（`src-tauri/resources/vbcable/`）：版权归 **Vincent Burel / VB-Audio** 所有，属 Donationware，**不受本项目 Apache-2.0 许可证约束**。依据其官方条款原样分发（AS IS，未做任何修改）：
  - 来源：www.vb-cable.com
